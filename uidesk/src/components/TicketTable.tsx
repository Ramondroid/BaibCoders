  ...
  return (
    <>
              ...
              {tickets.map((ticket, idx) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 space-x-3 whitespace-nowrap flex items-center">
                    ...
                    <button
                      onClick={() => openModal(ticket.description)}
                      className="flex items-center gap-1 px-4 py-2 rounded-lg text-xs font-semibold bg-blue-600 hover:bg-blue-700 text-white transition shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500"
      ...
      {modalOpen && (
        ...
        >
          <div
            className="bg-[#1e1f24] rounded-lg p-6 max-w-lg w-full shadow-lg"
            onClick={(e) => e.stopPropagation()}
          >
            <h3 className="text-xl font-semibold mb-4 text-white">Ticket Description</h3>
            <p className="text-gray-300 whitespace-pre-wrap">
              {modalDescription || 'No description provided.'}
            </p>
            <button
              onClick={closeModal}
