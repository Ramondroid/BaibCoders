...
export default function CopilotChatWrapper() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen ? (
        <div className="w-[600px] h-[760px] rounded-2xl shadow-2xl overflow-hidden backdrop-blur-md bg-[#2a2b31]/90 border-white/10">
          {/* Header */}
          <div
        ...
        <button
          ...
          className="h-[60px] w-[180px] flex items-center justify-center gap-2 px-6 py-3 
